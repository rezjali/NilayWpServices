    ...
    private function add_inline_admin_assets() {
        ...
        $js = "
            jQuery(document).ready(function($){
                ...
                // *** BUG FIX STARTS HERE ***
                // Use .off() to remove any previous handlers before attaching the new one.
                // This prevents the event from firing multiple times.
                $(document).off('click', '.add-repeater-field').on('click', '.add-repeater-field', function(e) {
                    e.preventDefault();
                ...
                $(document).off('click', '.remove-repeater-field').on('click', '.remove-repeater-field', function(e){
                    e.preventDefault();
                ...
                $(document).off('click', '.nsm-upload-button').on('click', '.nsm-upload-button', function(e) {
                    e.preventDefault();
                    var button = $(this);
