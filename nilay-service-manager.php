...
final class Nilay_Service_Manager {
    ...
    const VERSION = '4.5.2'; // Updated version for restructuring
            ...
            jQuery(document).ready(function($){
                ...
                $('.nsm-test-button').on('click', function(){
                    ...
                    $.post(ajaxurl, data, function(response) {
                        if(response.success) {
                            resultDiv.html('<strong>" . nsm_get_string('test_success', 'موفق') . ":</strong> ' + response.data).addClass('nsm-test-success');
                        } else {
                            resultDiv.html('<strong>" . nsm_get_string('test_error', 'خطا') . ":</strong> ' + response.data).addClass('nsm-test-error');
                        }
    ...
    private function add_inline_frontend_assets() {
        $css = "
            :root {
                ...
                --nsm-success-color: #10b981; --nsm-warning-color: #f59e0b; --nsm-dark-bg: #111827; --nsm-dark-card: #1f2937;
            ...
            .nsm-meta-info-item svg { width: 20px; height: 20px; margin-left: 15px; flex-shrink: 0; color: var(--nsm-primary-color); }
            ...
            .nsm-sidebar-box .nsm-meta-info-list { margin: -12px 0; } /* Adjust padding */

            /* --- Template 1: Modern Professional --- */
            .nsm-layout-1 { background-color: var(--nsm-bg-light); padding: 50px 0; }
            ...
            .nsm-layout-1 .nsm-hero-content h1 { font-size: 3.5em; font-weight: 700; margin-bottom: 20px; }
            ...
            .nsm-layout-1 .nsm-sidebar-box { background: #fff; padding: 30px; border-radius: 15px; box-shadow: var(--nsm-shadow); margin-bottom: 25px; }
            ...
            .nsm-layout-2 { padding-bottom: 40px; }
            ...
            .nsm-layout-2 .nsm-title-card { background: #fff; text-align:center; padding: 40px; border-radius: 15px; box-shadow: var(--nsm-shadow-lg); margin-bottom: 30px; }
            .nsm-layout-2 .nsm-title-card h1 { font-size: 3em; margin: 0; }
            .nsm-layout-2 .nsm-sidebar { position: sticky; top: 30px; }
            .nsm-layout-2 .nsm-sidebar-box { background: #fff; padding: 30px; border-radius: 15px; box-shadow: var(--nsm-shadow); margin-bottom: 25px; }
            ...
            .nsm-layout-3 .nsm-sidebar-box, .nsm-layout-3 .nsm-info-card { background: #fff; border-radius: 15px; box-shadow: var(--nsm-shadow); }
            .nsm-layout-3 .nsm-sidebar-box { padding: 30px; margin-bottom: 25px; }

            /* --- Template 4: Sleek Dark Mode --- */
            .nsm-layout-4 { background-color: var(--nsm-dark-bg); color: #d1d5db; padding: 50px 0; }
            ...
            .nsm-layout-4 .nsm-hero-content h1 { color: #fff; font-size: 3.5em; }
            .nsm-layout-4 .nsm-hero-image img { border-radius: 20px; border: 2px solid #374151; }
            ...
            .nsm-layout-4 .nsm-info-card, .nsm-layout-4 .nsm-sidebar-box { background-color: var(--nsm-dark-card); border: 1px solid #374151; }
            .nsm-layout-4 h2 { color: #fff; border-bottom-color: #374151; }
            ...
            .nsm-layout-4 .nsm-meta-info-item { border-bottom-color: #374151; }
            .nsm-layout-4 .nsm-meta-info-item svg { color: var(--nsm-secondary-color); }
            .nsm-layout-4 .nsm-meta-info-item .meta-label { color: #9ca3af; }
            .nsm-layout-4 .nsm-meta-info-item .meta-value { color: #d1d5db; }
            ...
            .nsm-layout-5 .nsm-sidebar-box { background: #fff; border: 1px solid var(--nsm-border-color); border-radius: 15px; box-shadow: var(--nsm-shadow-lg); margin-bottom: 25px; padding: 30px; }
            ...
            .nsm-layout-6 { background-color: var(--nsm-dark-bg); color: #d1d5db; padding: 50px 0; }
            ...
            .nsm-layout-6 .nsm-main-content h1 { font-size: 3.5em; color: #fff; }
            .nsm-layout-6 .nsm-info-card, .nsm-layout-6 .nsm-sidebar-box { background-color: transparent; border: 1px solid #374151; box-shadow: none; }
            .nsm-layout-6 h2 { color: #fff; border-bottom-color: #374151; }
            .nsm-layout-6 .nsm-sidebar { position: sticky; top: 30px; }
            .nsm-layout-6 .nsm-meta-info-item { border-bottom-color: #374151; }
            .nsm-layout-6 .nsm-meta-info-item svg { color: var(--nsm-secondary-color); }
            .nsm-layout-6 .nsm-meta-info-item .meta-label { color: #9ca3af; }
            .nsm-layout-6 .nsm-meta-info-item .meta-value { color: #d1d5db; }

            /* --- NEW Template 7: Dark Glassmorphism --- */
            .nsm-layout-7 { background: #0F2027; background: -webkit-linear-gradient(to right, #2C5364, #203A43, #0F2027); background: linear-gradient(to right, #2C5364, #203A43, #0F2027); color: #e0e0e0; padding: 50px 0; }
            .nsm-layout-7 .nsm-hero-content { text-align: center; padding: 50px 0; }
            .nsm-layout-7 .nsm-hero-content h1 { font-size: 4em; color: #fff; text-shadow: 0 2px 15px rgba(0,0,0,0.3); }
            ...
            .nsm-layout-7 .nsm-info-card, .nsm-layout-7 .nsm-sidebar-box { background: rgba(255, 255, 255, 0.05); -webkit-backdrop-filter: blur(10px); backdrop-filter: blur(10px); border: 1px solid rgba(255, 255, 255, 0.1); box-shadow: 0 8px 32px 0 rgba(0, 0, 0, 0.37); }
            .nsm-layout-7 h2 { color: #fff; border-bottom-color: rgba(255, 255, 255, 0.2); }
            .nsm-layout-7 .nsm-sidebar { position: sticky; top: 30px; }
            .nsm-layout-7 .nsm-meta-info-item { border-bottom-color: rgba(255, 255, 255, 0.2); }
            .nsm-layout-7 .nsm-meta-info-item svg { color: #fff; }
            .nsm-layout-7 .nsm-meta-info-item .meta-label { color: #ccc; }
            .nsm-layout-7 .nsm-meta-info-item .meta-value { color: #fff; }
        ";
